...
2. MTDC comes with 2 ports for CAN Bus. Unfortunatelly connector not included in the package therefore easiest way is to use dupont cables: use High pin on one connector and on Low pin on other. <img src="./.assets/01_SOREL_MTDC_Connection.png" alt="SOREL MTDC connection to Enapter ENP-CAN" width="25%" />
...
5. Click `Commands` on device screen. <img src="./.assets/03_Commands.jpg" alt="SOREL MTDC Blueprint Commands" width="25%" />

6. On the commands list screen click on `Main Configuration` command: <img src="./.assets/04_Configuration.jpg" alt="SOREL MTDC Blueprint Configuration Settings" width="25%" />
