# Normally Opened Contactor via ENP-RL6

This [Enapter Device Blueprint](https://go.enapter.com/marketplace-readme) integrates a **normally opened contactor** based on [Enapter ENP-RL6](https://go.enapter.com/handbook-enp-rl6).
