...
function send_telemetry()
    ...
    if err then
        ...
        telemetry.status = status
        telemetry.voltage = tonumber(jb["params"]["voltage"])
        telemetry.current = tonumber(jb["params"]["current"])
        telemetry.power = tonumber(jb["params"]["power"])
        telemetry.rssi = tonumber(jb["params"]["rssi"])
