...
function main()
    ...
    enapter.register_command_handler('switch_on_0', switch_on_0)
    enapter.register_command_handler('switch_off_0', switch_off_0)
    enapter.register_command_handler('switch_on_1', switch_on_1)
    enapter.register_command_handler('switch_off_1', switch_off_1)
    enapter.register_command_handler('switch_on_2', switch_on_2)
    enapter.register_command_handler('switch_off_2', switch_off_2)
    enapter.register_command_handler('switch_on_3', switch_on_3)
    enapter.register_command_handler('switch_off_3', switch_off_3)
end
