# Sonoff TH10/TH16 Smart Switch eWelink

This [Enapter Device Blueprint](https://github.com/Enapter/marketplace#blue_book-enapter-device-blueprints) integrates **Sonoff TH10 or TH16 Smart Switch** one channel relay with humidity and temperature sensors via [eWelink REST API Server](https://github.com/DoganM95/Ewelink-Rest-Api-Server). The Blueprint is running on [Enapter Virtual UCM](https://handbook.enapter.com/software/software.html#%F0%9F%92%8E-virtual-ucm). This Blueprint allow to control relay as well as monitor temperature and humidity.
...
The status data should be available on your **Sonoff TH10 or TH16 Smart Switch** dashboard as well as you can control your relay manually or automatic way with [Enapter Rules Engine](https://developers.enapter.com/docs/reference/rules/time)
