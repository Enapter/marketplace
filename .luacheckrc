...
stds.ucm = {
  read_globals = {
    ...
    enapter = {
      fields = {
        'log', 'send_properties', 'send_telemetry',
        'register_command_handler', 'on_connection_status_changed',
        'get_connection_status', 'err_to_str'
      }
    },
    storage = {
    ...
    rl6 = {
      fields = {
        'get', 'open', 'close', 'impulse', 'open_all', 'close_all',
        'set_all', 'err_to_str'
      }
    },
    ai4 = {
...
ignore = {
  ...
  '411/ok', '411/err', '411/result', '411/data',
  '421/ok', '421/err', '421/result', '421/data',
}
