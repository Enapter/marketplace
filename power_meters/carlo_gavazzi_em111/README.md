...
This [Enapter Device Blueprint](https://go.enapter.com/marketplace-readme) integrates **Carlo Gavazzi EM111** - single phase energy meter with [ModBus RTU](https://go.enapter.com/developers-enapter-modbus) over [RS-485 communication interface](https://go.enapter.com/developers-enapter-rs485).
...
- [Carlo Gavazzi EM111 product page](https://www.gavazziautomation.com/en-us/search?q=EM111DIN)
